...
## Methods
**XYZ SEQUENCES** were downloaded in fastq format into **SOFTWARE**. Our analysis took place on the University of New Hampshire RON cluster loaded with several conda environments.
...
See our code files (located at the top of this repository) for a comprehensive breakdown of the individual steps performed in **SOFTWARE** on this data.
